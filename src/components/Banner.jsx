    ...
    >
      ...
      >
        <div className="relative">
          ...
          {/* <div className="absolute -z-10 w-72 h-72 md:w-96 md:h-60 rounded-full bg-gradient-to-br from-primary/10 to-purple/10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div> */}
          <motion.div
            whileHover={{ scale: 1.05, rotate: -2 }}
            transition={{ type: "spring", stiffness: 300 }}
            className="relative z-10 conic"
          >
            ...
            <img
              className="object-cover rounded-2xl shadow-2xl  w-64 h-60 md:w-80 md:h-60 lg:w-[28rem] lg:h-[26rem]"
              src={img}
